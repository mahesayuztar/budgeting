...
/**
 * Tabel data dengan pencarian, muat ulang, dan gulir tak hingga berbasis
 ...
 * @param {(params: { cursor?: string; q?: string }) => Promise<Page<TData>>} props.fetchPage - Pengambil satu halaman data.
...
export function DataTable<TData extends RowData>({
  ...
  const query = useInfiniteQuery({
    ...
    queryFn: ({ pageParam }) => fetchPage({ cursor: pageParam, q: debouncedSearch || undefined }),
    initialPageParam: undefined as string | undefined,
    getNextPageParam: _lastPage => _lastPage.nextCursor ?? undefined,
    placeholderData: keepPreviousData,
    initialData: isSearching ? undefined : initialPage ? { pages: [initialPage], pageParams: [undefined] } : undefined,
  });
    ...
    <div className="flex flex-col gap-3">
      ...
      {isEmpty && (
        <EmptyState
          ...
          description={isSearching ? `Tidak ada data yang cocok dengan "${debouncedSearch}".` : emptyDescription}
        />
      )}
