...
const EMPTY_REGISTER_FORM: RegisterFormType = {
  name: '',
  username: '',
  email: '',
  password: '',
...
export default function RegisterForm() {
  ...
  const [form, setForm] = useState<RegisterFormType>(EMPTY_REGISTER_FORM);

  const { run, pending, error, fieldErrors } = useApiAction(authApi.register);

  function getFieldChangeHandler(key: keyof RegisterFormType) {
