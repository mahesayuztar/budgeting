 ...
 * Skema field ditaruh terpisah di berkas ini supaya keduanya tidak pernah
 * memakai aturan yang berbeda.
 */

export const nameField = z.string().trim().min(2, 'Nama minimal 2 karakter.').max(80);
...
export const usernameField = z
  ...
  .max(30)
  .regex(/^[a-z0-9._-]+$/, 'Username hanya boleh huruf, angka, titik, garis bawah, dan strip.');
